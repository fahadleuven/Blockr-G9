...
import com.swop.handlers.ScrollOffsetChangedHandler;

import java.awt.*;
import java.util.ArrayList;
import java.util.List;

abstract class WindowSectionDecorator implements WindowSection{
    protected WindowSection tempWindowSection;

    public WindowSectionDecorator (WindowSection newWindowSection) {
        tempWindowSection = newWindowSection;
        
    }
public int getWidth(){
        return tempWindowSection.getWidth();
}
public int getHeight(){
        return tempWindowSection.getHeight();
}
